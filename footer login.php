  ...
  <div class="overlay"></div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="single-footer-widget pl-5">
                            ...
                            <ul class="social-links">
                                ...
                                <li><a href="https://www.tiktok.com/@d_amaliah?_t=8kAKOEWyfGZ&_r=1" class="tiktok"><i class="fa-brands fa-tiktok"></i></a></li>
    ...
    document.getElementById("tahun-pembuatan").textContent = tahunSekarang;
        ...
        <style>
            ...
            .single-footer-widget ul.social-links li a.tiktok {
            border-color: #000;
            color: #000;
            }

            .single-footer-widget ul.social-links li a.tiktok:hover {
            background: #000;
            color: #ffffff;
            }
